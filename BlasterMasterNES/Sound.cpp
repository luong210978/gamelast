...
void Sound::StopAll()
{
	...
	Stop("PlayerBulletHitBrick");
	Stop("PlayerFireUnderWorld");
	Stop("PlayerFireOverWorld");
	Stop("BossFire");
	Stop("PlayerJump");
	Stop("EnemyBulletBang");
	Stop("PlayerInjured");
	Stop("PickingItems");
	Stop("TeleporterTransform");
	Stop("Enemydie");
	Stop("BossIntro");
	Stop("GameOver");
	Stop("LifeLost");
	...
	Stop("PlayerInjured");
	Stop("FireRocket");
	Stop("TransingWeaponScene");
	Stop("FireHomingMissles");
	Stop("SkullFire");
	Stop("BossDie");
	Stop("TankDie");
	Stop("Blink");
